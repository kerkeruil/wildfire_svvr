...
def main(filename="output.60000.vts", output_file="test.png"):
    #### disable automatic camera reset on 'Show'
    paraview.simple._DisableFirstRenderCameraReset()

    # create a new 'XML Structured Grid Reader'
    output60000vts = XMLStructuredGridReader(registrationName=filename, FileName=[f'C:\\Users\\Gebruiker\\Desktop\\Visualization\\wildfire_svvr\\data\\{filename}'])
    ...
    contour1.Isosurfaces = [299.7328796386719, 310.87367078993054, 322.0144619411892, 333.15525309244794, 344.2960442437066, 355.43683539496527, 366.57762654622394, 377.71841769748266, 388.85920884874133, 400.0]
    ...
    contour1_1.Isosurfaces = [400.0, 488.6494954427083, 577.2989908854166, 665.948486328125, 754.5979817708333, 843.2474772135416, 931.89697265625, 1020.5464680989583, 1109.1959635416665, 1197.845458984375]
    ...
    renderView1.CameraPosition = [-365.17559544328503, 3401.2482541128343, 987.6305256599602]
    renderView1.CameraFocalPoint = [101.00000000000013, -1.0000000000001845, 449.6810739338396]
    renderView1.CameraViewUp = [0.024443066925396037, -0.15286066652380922, 0.987945420106383]
    renderView1.CameraParallelScale = 899.6336487340902
    ...
    SaveScreenshot("test.png", GetLayout())
    #
